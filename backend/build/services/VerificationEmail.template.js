...
exports.clientVerificationEmail = void 0;
const index_config_1 = require("../config/index.config");
const clientVerificationEmail = (name, token) => {
    const verifyUrl = `${index_config_1.appConfig.app.clientUrl}/verify/${token}`;
...
exports.clientVerificationEmail = clientVerificationEmail;
