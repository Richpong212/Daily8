...
export const appConfig = {
  ...
  s3: {
    ...
    propertyImagePrefix:
      process.env.AWS_S3_PROPERTY_IMAGE_PREFIX || "property-images",
    publicBaseUrl: process.env.AWS_S3_PUBLIC_BASE_URL,
    presignedUploadTtlSeconds: numberFromEnv(
      process.env.AWS_PRESIGNED_UPLOAD_TTL_SECONDS,
      300,
    ),
    propertyImageMaxBytes: numberFromEnv(
      process.env.PROPERTY_IMAGE_MAX_BYTES,
      5 * 1024 * 1024,
    ),
